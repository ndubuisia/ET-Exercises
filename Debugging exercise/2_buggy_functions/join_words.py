...
def join_words(words: list, separator: str) -> str:
    ...
    result = ""
    for word in words:
        #checks the datatype of each word to make sure it is a string
        assert isinstance(word, str), "list should contain only strings"
        result = result + word + separator
        
    #removes any separator at the end of the string
